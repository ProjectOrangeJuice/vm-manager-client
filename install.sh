...
start-stop-daemon --start --exec /usr/local/bin/vm-manager-client --chdir /etc/vm-manager-client --background --stdout /var/log/vm-client.log --stderr /var/log/vm-client-error.log
eend $?
}
